...
- [ ] Chạy `scripts\run_sim_vivado.bat` trên Windows có Vivado 2022.2 và cập nhật report bằng log thật.

- [ ] Chạy `scripts/run_dsp_experiments.sh` hoặc `scripts\run_dsp_experiments.bat` trên máy có Vivado để điều tra `DSP = 0` theo từng top và cập nhật `docs/dsp_experiment_report.md` bằng report thật.
