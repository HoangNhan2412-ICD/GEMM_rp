...
4. Người dùng đã verified resource và post-implementation timing 100 MHz từ Vivado report thật; nguyên nhân `DSP = 0` và số liệu power vẫn **Needs verification**.
